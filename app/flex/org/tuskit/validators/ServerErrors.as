package org.tuskit.validators {
    ...
    public class ServerErrors {
        ...
        /**
         * The errors on specific fields (base errors are on the BASE).
         * The keys are the field Strings; the values are Arrays of errors.
         */
        ...
        /**
         * Return an Array of the errors (just Strings) for the field,
